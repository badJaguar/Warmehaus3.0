...
export class MetaSrartPage implements IMetaData {
  ...
  // tslint:disable-next-line:max-line-length
  descriptionContent = 'Качественные теплые полы по приемлимым ценам: Германия, Дания. Норвегия. Россия. Пленочный ифракрастный пол: Корея. Большой выбор терморегуляторов для теплых полов: аналоговые, wi-fi, сенсорные, системы антиоблединения крыш (кровельных покрытий) высокого качества. Всё это представляет компания WÄRMEHAUS GmbH в Беларуси.';
  ogTitle = 'og:title';
