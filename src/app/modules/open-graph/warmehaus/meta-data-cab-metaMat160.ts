...
export class MetaMat160 implements IMetaData {
  ...
  // tslint:disable-next-line:max-line-length
  descriptionContent = 'WÄRMEHAUS ® Тонкий двужильный нагревательный мат на сетке, с шагом кабеля 7см и диаметром 3мм с двойной изоляцией и холодным соединительным проводом длиной 3.5м. Укладывается в слой плиточного клея.';
  ogTitle = 'og:title';
  ogTitleContent = 'Системы теплого пола "Мат 160 Ватт"';
  ogDescription = 'og:description';
  // tslint:disable-next-line:max-line-length
  ogDescriptionContent = 'WÄRMEHAUS ® Тонкий двужильный нагревательный мат на сетке, с шагом кабеля 7см и диаметром 3мм с двойной изоляцией и холодным соединительным проводом длиной 3.5м. Укладывается в слой плиточного клея.';
  ogType = 'og:type';
